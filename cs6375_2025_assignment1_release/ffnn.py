...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        print("Training accuracy for epoch {}: {}".format(epoch + 1, tra_acc))
        ...
        if val_acc < best_val_acc and tra_acc > best_tra_acc:
            counter += 1
        else:
        ...
        if counter >= patience:
            ...
            print("Best training accuracy is {}".format(best_tra_acc))
            print("Overfitting. Early stopping triggered.")
            break  # Stop training
